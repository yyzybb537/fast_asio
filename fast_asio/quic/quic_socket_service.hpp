...
class quic_socket_service
  : public boost::asio::detail::service_base<quic_socket_service<Protocol> >
{
public:
...
public:
  ...
  typedef shared_ptr<udp_handle> native_handle_type;

  /// The type of a stream socket implementation.
  struct implementation_type {
    native_handle_type udp_ptr;

    // TODO: quic socket or stream handle shared_ptr
  ...
  explicit quic_socket_service(boost::asio::io_context& io_context)
    : boost::asio::detail::service_base<
        quic_socket_service<Protocol> >(io_context)
  {
  }
