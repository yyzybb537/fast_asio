...
class basic_socket_acceptor
  : public fast_asio::detail::basic_socket<Protocol, Service>
{
public:
  /// The type of the executor associated with the object.
  typedef io_context::executor_type executor_type;

  typedef fast_asio::detail::basic_socket<Protocol, Service> base_type;
        ...
        basic_socket_acceptor<Protocol1 BOOST_ASIO_SVC_TARG1>&& other)
  {
    ...
    base_type::operator=(std::move(tmp));
    return *this;
  }
  ...
  {
    return base_type::get_io_context();
  }
