...
public:
...
#else
  typedef typename Service::native_handle_type native_handle_type;
#endif
  ...
  typedef basic_socket<Protocol ServiceARG> lowest_layer_type;
  ...
  explicit basic_socket(boost::asio::io_context& io_context)
    : basic_io_object<Service>(io_context)
  {
  }
  ...
  basic_socket(basic_socket&& other)
    : basic_io_object<Service>(std::move(other))
  {
  }
  ...
  {
    basic_io_object<Service>::operator=(std::move(other));
    return *this;
  }

  // All sockets have access to each other's implementations.
  template <typename Protocol1 ServicePARAM1>
   ...
   */
  template <typename Protocol1 ServicePARAM1>
  basic_socket(basic_socket<Protocol1 ServiceARG1>&& other,
  ...
  typename enable_if<is_convertible<Protocol1, Protocol>::value,
      basic_socket>::type& operator=(
        basic_socket<Protocol1 ServiceARG1>&& other)
  {
    basic_socket tmp(std::move(other));
    basic_io_object<Service>::operator=(std::move(tmp));
    return *this;
  }
  ...
  {
    return basic_io_object<Service>::get_io_context();
  }
  ...
  {
    return basic_io_object<Service>::get_io_service();
  }
  ...
  {
    return basic_io_object<Service>::get_executor();
  }
